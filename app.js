...
const p1 = new Producto(1,"remera",8000)
const p2 = new Producto(2,"short",6500)
const p3 = new Producto(3,"yoggins",9500)
const p4 = new Producto(4,"buzo",12000)
const p5 = new Producto(5,"campera",15000)
